...
module.exports = function (grunt) { // jshint ignore:line
  ...
  grunt.initConfig({
    ...
    // This task will compile all less files upon saving to create both SimcoGroup.css and SimcoGroup.min.css
    less  : {
    ...
    concat: {
      options: {
        separator: '\n\n',
        banner   : '/*! SimcoGroup app.js\n'
        + '* ================\n'
        + '* Main JS application file for SimcoGroup v2. This file\n'
        + '* should be included in all pages. It controls some layout\n'
        + '* options and implements exclusive SimcoGroup plugins.\n'
        + '*\n'
        ...
        + 'throw new Error(\'SimcoGroup requires jQuery\')\n'
        + '}\n\n'
      },
      dist   : {
        src : [
        ...
        dest: 'dist/js/SimcoGroup.js'
      }
    },

    // Replace image paths in SimcoGroup without plugins
    replace: {
      withoutPlugins   : {
