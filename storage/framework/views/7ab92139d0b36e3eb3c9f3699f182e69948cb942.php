            ...
            <div class="col-md-8 col-centered">
                <form class="form-auth-small" method="POST" action="<?php echo e(route('register')); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" id="signup-email"name="name" value="<?php echo e(old('name')); ?>" required autofocus placeholder="Name">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sahin\Desktop\SimcoGroup-Inventory\inventorySimcogroup\resources\views/auth/register.blade.php ENDPATH**/ ?>