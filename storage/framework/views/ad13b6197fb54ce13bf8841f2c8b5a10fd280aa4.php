        ...
        <div class="col-md-11">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="PATCH" action="<?php echo e(route('country.update', $country->id)); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sahin\Desktop\InventoryMS\resources\views/system-mgmt/country/edit.blade.php ENDPATH**/ ?>