...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/components/bootstrap/dist/css/bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/components/font-awesome/css/font-awesome.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/components/Ionicons/css/ionicons.min.css')); ?>">
...
<!-- REQUIRED JS SCRIPTS -->
<script src="<?php echo e(asset('assets/components/jquery/dist/jquery.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/components/bootstrap/dist/js/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/dist/js/SimcoGroup.min.js')); ?>"></script>
<?php echo $__env->yieldContent('bot'); ?>
</body>
</html>
<?php /**PATH C:\Users\Sahin\Downloads\2PGM-Cinar-Sahin-SimcoGroupInventaris\2PGM-Cinar-Sahin-SimcoGroupInventaris\inventorySimcogroup\resources\views/layouts/master.blade.php ENDPATH**/ ?>