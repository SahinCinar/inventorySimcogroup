...
@section('top')
    ...
    <!-- daterange picker -->
    <link rel="stylesheet" href="{{ asset('assets/components/bootstrap-daterangepicker/daterangepicker.css') }}">
...
@section('bot')
    ...
    <script src="{{ asset('assets/components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js') }}"></script>
