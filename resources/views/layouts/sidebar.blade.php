<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="{{ route('sales.index') }}"><i class="fa fa-cart-plus"></i> <span>Sales</span></a></li>
            ...
            <li><a href="{{ route('employee-management.index') }}"><i class="fa fa-users"></i> <span>Employee's</span></a></li>
            <li><a href="{{ route('department.index') }}"><i class="fa fa-solid fa-building"></i> <span>Departments</span></a></li>
            <li class="treeview">
